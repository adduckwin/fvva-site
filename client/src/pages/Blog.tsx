...
export default function Blog() {
  useMeta({
    ...
    description:
      "Статьи психолога Александры Федоровой о депрессии, тревожных расстройствах, панических атаках и повседневных ситуациях. Научно обоснованная информация и практические советы.",
    keywords:
      "блог психолога, статьи о депрессии, статьи о тревоге, психическое здоровье, КПТ, ACT, психология",
    ogType: "website",
  });
